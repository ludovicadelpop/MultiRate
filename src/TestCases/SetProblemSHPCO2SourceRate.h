/*
 * SetProblemSHPCO2SourceRate.h
 *
 *  Created on: 14 déc. 2015
 *      Author: delpopol
 */

#ifndef SETPROBLEMSHPCO2SOURCERATE_H_
#define SETPROBLEMSHPCO2SOURCERATE_H_
...
GeochemistryParameters getParameters(RealVector& y0){
	    ...
	    ChemicalReaction reactionH2O("reactionH2O",1.e4);
	    KeyReal sp1("H2O",1);
	    ...
	    ChemicalReaction reactionCO2aq("reactionCO2aq",1.e4);
		KeyReal sp4("HCO3-",1);
		...
		KeyReal sp28("H2O",0.0);
		sourceRate.setSourceRate(sp28);

		KeyReal sp29("H+",0.0);
		sourceRate.setSourceRate(sp29);

		KeyReal sp30("(CO2)aq",0.0);
		sourceRate.setSourceRate(sp30);

		KeyReal sp31("Cl-",0.0);
		sourceRate.setSourceRate(sp31);

		KeyReal sp32("Na+",0.0);
		sourceRate.setSourceRate(sp32);

		KeyReal sp33("Ca++",0.0);
		sourceRate.setSourceRate(sp33);

		KeyReal sp34("(SiO2)aq",0.0);
		sourceRate.setSourceRate(sp34);

		KeyReal sp35("HCO3-",0.0);
		sourceRate.setSourceRate(sp35);

		KeyReal sp36("OH-",0.0);
		sourceRate.setSourceRate(sp36);

		KeyReal sp37("(CO2)g",0.0);
		sourceRate.setSourceRate(sp37);

		KeyReal sp38("(CaCO3)s",0.0);
		sourceRate.setSourceRate(sp38);

		KeyReal sp39("(SiO2)s",0.0);
		sourceRate.setSourceRate(sp39);
...
#endif /* SETPROBLEMSHPCO2SOURCERATE_H_ */
